...
public interface ParametroService {
    ApiResponse listado(Integer tipoSQL, Integer codModulo, Integer codOpcion, Integer codPrefijo, String desc1, String desc2, String desc3, Integer int01, Integer int02, Integer idEstado) throws ServiceException;
